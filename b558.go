...
func (client *b558) ProtocolVersion() int {
	return client.protocolVersion
}

func (client *b558) OverrideProtocolVersion(version int) {
	client.protocolVersion = version
}

func (client *b558) ReadPacket(stream io.Reader) (packet *BanchoPacket, err error) {
	packet = &BanchoPacket{}
...
func (client *b558) SupportedPackets() []uint16 {
...
func (client *b558) ImplementsPacket(packetId uint16) bool {
...
func (client *b558) ReadPacketType(packetId uint16, reader io.Reader) (any, error) {
	switch packetId {
...
func (client *b558) ReadMatch(reader io.Reader) (*Match, error) {
	var err error
	...
	// There are multiple versions of b558, which have different
...
func (client *b558) WriteMatch(writer io.Writer, match Match) error {
...
func (client *b558) WriteMatchUpdate(stream io.Writer, match Match) error {
	writer := bytes.NewBuffer([]byte{})
	client.WriteMatch(writer, match)
	return client.WritePacket(stream, BanchoMatchUpdate, writer.Bytes())
}

func (client *b558) WriteMatchNew(stream io.Writer, match Match) error {
	writer := bytes.NewBuffer([]byte{})
	client.WriteMatch(writer, match)
	return client.WritePacket(stream, BanchoMatchNew, writer.Bytes())
}

func (client *b558) WriteMatchJoinSuccess(stream io.Writer, match Match) error {
	writer := bytes.NewBuffer([]byte{})
	client.WriteMatch(writer, match)
	return client.WritePacket(stream, BanchoMatchJoinSuccess, writer.Bytes())
}

func (client *b558) WriteMatchStart(stream io.Writer, match Match) error {
	writer := bytes.NewBuffer([]byte{})
	client.WriteMatch(writer, match)
