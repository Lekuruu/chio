...
const (
	UserPermissionsNone       = 0
	UserPermissionsRegular    = 1 << 0
	UserPermissionsBAT        = 1 << 1
	UserPermissionsSupporter  = 1 << 2
	UserPermissionsFriend     = 1 << 3
	UserPermissionsPeppy      = 1 << 4
	UserPermissionsTournament = 1 << 5
)
